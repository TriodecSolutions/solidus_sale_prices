...
[![CircleCI][![Test](https://github.com/solidusio/solidus_sale_prices/actions/workflows/test.yml/badge.svg)](https://github.com/solidusio/solidus_sale_prices/actions/workflows/test.yml)
[![codecov](https://codecov.io/gh/solidusio-contrib/solidus_sale_prices/branch/main/graph/badge.svg)](https://codecov.io/gh/solidusio-contrib/solidus_sale_prices)
...
Add solidus_sale_prices to your Gemfile:
...
```shell
bin/rails generate solidus_sale_prices:install
```
